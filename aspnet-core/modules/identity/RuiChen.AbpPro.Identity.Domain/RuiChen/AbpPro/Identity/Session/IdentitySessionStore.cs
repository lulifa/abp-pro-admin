...
namespace RuiChen.AbpPro.Identity
{
    public class IdentitySessionStore : IIdentitySessionStore, ITransientDependency
    {
        ...
        public IIdentitySessionRepository IdentitySessionRepository { get; }
        ...
        public async Task<IdentitySession> CreateAsync(
            string sessionId,
            string device,
            string deviceInfo,
            Guid userId,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            await IdentitySessionRepository.InsertAsync(identitySession, cancellationToken: cancellationToken);
