...
using VoloIIdentityUserRepository = Volo.Abp.Identity.IIdentityUserRepository;

namespace RuiChen.AbpPro.Identity
{
    public interface IIdentityUserRepository : VoloIIdentityUserRepository
    {
        /// <summary>
        /// 手机号是否已被使用
        /// </summary>
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<bool> IsPhoneNumberConfirmedAsync(string phoneNumber, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task<bool> IsNormalizedEmailConfirmedAsync(string normalizedEmail, CancellationToken cancellationToken = default);
