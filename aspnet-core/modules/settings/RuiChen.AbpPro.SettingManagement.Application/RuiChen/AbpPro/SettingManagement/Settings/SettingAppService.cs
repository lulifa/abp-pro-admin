    ...
    public class SettingAppService : ApplicationService, ISettingAppService, ISettingTestAppService
    {
        ...
        protected async virtual Task<SettingGroupResult> GetAllForProviderAsync(string providerName, string providerKey)
        {
            ...
            userSetting.AddDetail(
                ...
                providerName);
            userSetting.AddDetail(
                await SettingDefinitionManager.GetAsync(Identity.IdentitySettingNames.User.SmsNewUserRegister),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Identity.IdentitySettingNames.User.SmsNewUserRegister, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                await SettingDefinitionManager.GetAsync(Identity.IdentitySettingNames.User.SmsResetPassword),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Identity.IdentitySettingNames.User.SmsResetPassword, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                await SettingDefinitionManager.GetAsync(Identity.IdentitySettingNames.User.SmsUserSignin),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Identity.IdentitySettingNames.User.SmsUserSignin, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                await SettingDefinitionManager.GetAsync(Identity.IdentitySettingNames.User.SmsPhoneNumberConfirmed),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Identity.IdentitySettingNames.User.SmsPhoneNumberConfirmed, providerName, providerKey),
                ValueType.String,
                providerName);
            userSetting.AddDetail(
                await SettingDefinitionManager.GetAsync(Identity.IdentitySettingNames.User.SmsRepetInterval),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Identity.IdentitySettingNames.User.SmsRepetInterval, providerName, providerKey),
                ValueType.Number,
                providerName);
