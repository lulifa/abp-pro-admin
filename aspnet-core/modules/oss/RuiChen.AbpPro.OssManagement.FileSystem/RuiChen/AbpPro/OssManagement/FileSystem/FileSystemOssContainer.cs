...
{
    public class FileSystemOssContainer : OssContainerBase, IOssObjectExpireor
    {
        ...
        protected virtual string CalculateFilePath(string bucketName, string blobName = "")
        {
            ...
            if (fileSystemConfiguration.AppendContainerNameToBasePath && !bucketName.IsNullOrWhiteSpace())
            {
