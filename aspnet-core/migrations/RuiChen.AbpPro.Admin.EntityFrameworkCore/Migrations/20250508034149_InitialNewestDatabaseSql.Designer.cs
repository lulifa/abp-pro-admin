...
namespace RuiChen.AbpPro.Admin.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20250508034149_InitialNewestDatabaseSql")]
    partial class InitialNewestDatabaseSql
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RuiChen.Platform.Data", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.Platform.DataItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.Platform.Layout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.Platform.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.Platform.RoleMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.Platform.UserFavoriteMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.Platform.UserMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RuiChen.AbpPro.Saas.TenantConnectionString", b =>
                {
                    b.HasOne("RuiChen.AbpPro.Saas.Tenant", null)
            ...
            modelBuilder.Entity("RuiChen.Platform.DataItem", b =>
                {
                    b.HasOne("RuiChen.Platform.Data", null)
                        .WithMany("Items")
